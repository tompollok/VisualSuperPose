...
def read_csv(source_path="./", target_path="./", csv_path="./"):
...
def parse_arguments():
    ...
    parser.add_argument("--source_path", type=str, help="Path to train images directory")
    parser.add_argument("--target_path", type=str, help="Path to train clean images directory")
...
def main():
    print("start")
    # python filter_database.py --source_path D:/Datasets/GoogleLandmarks/train --target_path D:/Datasets/test/train_clean --csv_path D:/Datasets/GoogleLandmarks/train/train_clean.csv
    config = parse_arguments()
    source_path = config.source_path
    target_path = config.target_path
    csv_path = config.csv_path
    read_csv(source_path, target_path, csv_path)
    print("finished")
